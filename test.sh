...
surum="3.0"
MAKSIMUMPROXY=2501
token="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"
...
if ! curl --insecure -s https://$token@raw.githubusercontent.com/itseyup/ipv6proxyscript/main/scstate | grep "aktif"
then
clear
echo -e "${RENK3}##################################################"
echo -e "${RENK3}#                ${RENK2}RiseScript-Proxy                ${RENK3}#"
echo -e "${RENK3}##################################################"
echo -e "${RENK3}#               ${RENK2}Script aktif değil!              ${RENK3}#"
echo -e "${RENK3}##################################################"
echo -e "${RENK3}# ${RENK2}Scripte eklenen güvenlik önlemleri nedeniyle   ${RENK3}#"
echo -e "${RENK3}# ${RENK2}Scripte erişim şimdilik kesilmiştir.           ${RENK3}#"
echo -e "${RENK3}# ${RENK2}Eğer iletişime geçmek isterseniz numaram:      ${RENK3}#"
echo -e "${RENK3}# ${RENK2}WhatsApp: ${RENK5}$(curl -s --insecure https://gitfront.io/r/eyup/SsyYME9MACpx/bilgiler/raw/whatsapp-numaram)"
echo -e "${RENK3}##################################################${RENK0}"
exit
fi
...
git clone https://$token@github.com/itseyup/ipv6proxyscript
mv ipv6proxyscript 3proxy
cd 3proxy
...
curl --insecure -4 --upload-file ./proxylist.zip https://transfer.sh >> .transfersh-link
bitissuresi=$(date +%s)
clear
echo -e "${RENK3}##################################################"
echo -e "${RENK3}#                ${RENK2}RiseScript-Proxy                ${RENK3}#"
...
echo -e "${RENK3}# ${RENK2}• Proxy Listesi Transfer.SH Sitesine Yüklenmiştir."
echo -e "${RENK3}# ${RENK2}• Link: ${RENK5}$(cat .transfersh-link)"
